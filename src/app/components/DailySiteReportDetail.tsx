import { X, Download, Calendar, Users, Wrench, AlertTriangle, Camera, MapPin, Clock, ArrowLeft } from 'lucide-react';

interface DailySiteReportDetailProps {
  isOpen: boolean;
  reportId: string | null;
  onClose: () => void;
}

export function DailySiteReportDetail({ isOpen, reportId, onClose }: DailySiteReportDetailProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 overflow-y-auto">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-[1200px] my-8">
        {/* Header - Professional Report Title */}
        <div className="bg-gradient-to-r from-slate-800 to-slate-900 px-8 py-6 rounded-t-xl">
          {/* Back Button Row */}
          <div className="mb-4">
            <button
              onClick={onClose}
          ...
          <div className="grid grid-cols-2 gap-6 mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 rounded-lg p-5 border border-slate-200">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="text-[12px] text-slate-600 leading-relaxed whitespace-pre-line bg-white p-3 rounded border border-slate-200">
              ...
              <div className="bg-slate-50 rounded-lg p-5 border border-slate-200">
                ...
                <p className="text-[12px] text-slate-600 leading-relaxed bg-white p-3 rounded border border-slate-200">
                  {report.notes}
                </p>
              </div>
            </div>
